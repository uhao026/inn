...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="toHead"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="toLeft" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="toMain" name="main" scrolling="yes" noresize="noresize"
