...
<title>修改密码</title>
<link rel="stylesheet" type="text/css" href="after/css/css.css" />
<script type="text/javascript" src="after/js/jquery.min.js"></script>
</head>
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="after/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
			...
			<div class="bacen">
				...
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						...
						src="after/img/ok.png" /><img class="imgb" src="after/img/no.png" />
				</div>
				<div class="bbD">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" onblur="checkpwd3()"
						id="pwd3" /> <img class="imga" src="after/img/ok.png" /><img
						class="imgb" src="after/img/no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
